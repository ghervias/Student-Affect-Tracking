...
public class CodeEditor extends StackPane {
    ...
    private final String editingTemplate =
            "<!doctype html>" +
                    "<html>" +
                    "<head>" +
                    "  <link rel=\"stylesheet\" href=\"http://codemirror.net/5/lib/codemirror.css\">" +
                    "  <script src=\"http://codemirror.net/5/lib/codemirror.js\"></script>" +
                    "  <script src=\"http://codemirror.net/5/mode/clike/clike.js\"></script>" +
                    "</head>" +
                    "<body>" +
    ...
    public CodeEditor() {
        this(""); // Default to an empty string for editingCode
    }
}
